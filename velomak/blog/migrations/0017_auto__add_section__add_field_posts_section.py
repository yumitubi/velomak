...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_section', (
            ...
            ('section', self.gf('django.db.models.fields.CharField')(default='\xd0\x93\xd0\xbb\xd0\xb0\xd0\xb2\xd0\xbd\xd0\xb0\xd1\x8f', unique=True, max_length=64)),
        ...
        db.add_column('blog_posts', 'section',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='\xd0\x93\xd0\xbb\xd0\xb0\xd0\xb2\xd0\xbd\xd0\xb0\xd1\x8f', to=orm['blog.Section']),
                      keep_default=False)
    ...
    models = {
        ...
        'blog.posts': {
            ...
            'section': ('django.db.models.fields.related.ForeignKey', [], {'default': "'\\xd0\\x93\\xd0\\xbb\\xd0\\xb0\\xd0\\xb2\\xd0\\xbd\\xd0\\xb0\\xd1\\x8f'", 'to': "orm['blog.Section']"}),
        ...
        'blog.section': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'section': ('django.db.models.fields.CharField', [], {'default': "'\\xd0\\x93\\xd0\\xbb\\xd0\\xb0\\xd0\\xb2\\xd0\\xbd\\xd0\\xb0\\xd1\\x8f'", 'unique': 'True', 'max_length': '64'}),
            'weight': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        },
        'blog.tags': {
