...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.type_show_list_post'
        db.add_column('blog_section', 'type_show_list_post',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.type_show_list_post'
        db.delete_column('blog_section', 'type_show_list_post')
    ...
    models = {
        ...
        'blog.section': {
            ...
            'type_show_list_post': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'weight': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        },
        'blog.tags': {
