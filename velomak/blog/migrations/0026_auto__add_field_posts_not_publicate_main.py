...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Posts.not_publicate_main'
        db.add_column('blog_posts', 'not_publicate_main',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Posts.not_publicate_main'
        db.delete_column('blog_posts', 'not_publicate_main')
