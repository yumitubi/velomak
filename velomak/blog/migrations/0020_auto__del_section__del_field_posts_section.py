...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('blog_section', (
            ('section', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True, blank=True)),
        ...
        # User chose to not deal with backwards NULL issues for 'Posts.section'
        raise RuntimeError("Cannot reverse this migration. 'Posts.section' and its values cannot be restored.")
